...
% damn syntax highlighter gets confused by opening $
% fix this:
\newcommand{\willneverbeusedforanything}{$}
...
\noalign{\vskip7pt\hbox to 5.2cm{\hfill\downsquigarrow}\vskip7pt}%
}
...
%\begin{array}{@{\matops@leftparen}R@{}c@{}C@{}c@{}L@{\matops@rightparen}}
\newenvironment{trimatrixoperations}{%
