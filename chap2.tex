...
\begin{thLemma}[Elementarteilersatz für Matrizen]\label{ets:matrix}
    ...
    Dabei erfüllen außerdem die Einträge $\alpha_1,\ldots,\alpha_s\in
    R\!\setminus\!\{0\}$ ($0\leq s\leq \min(m,n)$) für $i\in\{1,\ldots,s-1\}$ die Bedingung:
    ...
    $S\!AT$ in der Literatur auch \emph{Smith-Normalform}, insbesondere im
...
\begin{proofsketch}[ zur Existenzaussage]
    ...
    (Siehe auch \cite[Def.~4]{talk:rief}.) % TODO: check cite!
...
\begin{thKorollar}[Eindeutigkeitsaussage in %
                   \texorpdfstring{\cref{ets:matrix}}{der Matrixversion}]
